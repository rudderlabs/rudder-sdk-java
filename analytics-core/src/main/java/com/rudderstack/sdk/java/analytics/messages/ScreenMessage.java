...
import com.rudderstack.sdk.java.analytics.messages.AutoValue_ScreenMessage;
 ...
 *
 * @see <a href="https://rudder.com/docs/spec/screen/">Screen</a>
 */
@AutoValue
@AutoGson //
public abstract class ScreenMessage implements Message {
   ...
   * @see <a href="https://rudder.com/docs/spec/screen/#name">Name</a>
   */
  ...
  public static class Builder extends MessageBuilder<ScreenMessage, Builder> {
     ...
     *
     * @see <a href="https://rudder.com/docs/spec/screen/#properties">Properties</a>
     */
